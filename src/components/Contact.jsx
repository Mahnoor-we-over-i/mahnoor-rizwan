        ...
        <div className="space-y-6 mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3 bg-gradient-to-r from-peach to-lavender text-gray-800 rounded-full font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105 inline-block"
            >
              CV
            </a>
          </div>
